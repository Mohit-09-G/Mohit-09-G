...
<a href="https://git.io/typing-svg">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=22&pause=1000&color=A78BFA&center=true&vCenter=true&width=600&lines=Flutter+Developer+%7C+1.7%2B+Years+Experience;Frontend+Engineer+%7C+React+%26+Next.js;DSA+Practitioner+in+Java;Android+Dev+with+Java+%26+Kotlin;Building+Elegant%2C+Performant+Apps+%F0%9F%9A%80" alt="Typing SVG" />
</a>
...
data class Developer(
    ...
    val role: String        = "Frontend Software Engineer",
    val experience: String  = "1.7+ Years in Flutter",
    val email: String       = "mohitofficial2042@gmail.com",
    val learning: List<String> = listOf("Java", "Kotlin", "Android", "Next.js"),
    val passions: List<String> = listOf("Clean UI", "DSA", "Open Source", "Innovation")
)
```
...
- 🌱 Learning **Next.js & React** ecosystem deeply
- 💡 Solving **DSA problems in Java** daily — Arrays, Trees, Graphs, DP
- 🎯 Goal: Become a **Full-Stack Mobile + Web Engineer**
- 📖 Mastering **Clean Architecture** & **SOLID principles**
